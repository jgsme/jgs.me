...
This package is a Cloudflare Worker (`w-notify`). It notifies a Discord channel about unregistered pages and handles the button presses on those notifications.
